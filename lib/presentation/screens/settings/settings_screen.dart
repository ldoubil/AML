import 'package:aml/presentation/components/dialogs/modal_animated_dialog.dart';
import 'package:aml/presentation/components/settings/settings_navigation_panel.dart';
...
class _SettingsScreenState extends State<SettingsScreen>
  ...
  String _selectedPageId = SettingsRegistry.pages.first.id;
  ...
  Widget _getCurrentPage() {
    final currentConfig = SettingsRegistry.pages.firstWhere(
      (config) => config.id == _selectedPageId,
      orElse: () => SettingsRegistry.pages.first,
    );
